...
from compare import homography
from compare import bruteForce
from compare import knnBruteForce
from compare import Flann
...
for chunk_index in range(num_chunks):
    ...
    with concurrent.futures.ThreadPoolExecutor() as executor:
        results = list(executor.map(process_image, current_chunk))
